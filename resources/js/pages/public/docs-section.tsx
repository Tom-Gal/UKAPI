...
> = {
    ...
    errors: {
        ...
        sections: [
            ...
            [
                'Useful codes',
                'invalid_api_key, api_key_revoked, quota_exceeded, rate_limit_exceeded, invalid_postcode, postcode_not_found, invalid_company_number, company_not_found, invalid_sic_code, sic_not_found, sic_reference_unavailable, invalid_coordinates and upstream_unavailable.',
            ],
            [
                'Support context',
